//! The grid: wrapping, distances, the symmetry a board is built on, and the bitmaps and seeded
//! randomness the rules are written in.
//!
...
/// splitmix64: seeded, portable and integer-only, because game logic has no floating point
/// (`tools/deny.sh`).
